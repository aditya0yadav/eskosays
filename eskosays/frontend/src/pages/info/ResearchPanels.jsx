...
const ResearchPanels = () => {
    const features = [
        {
            icon: <ShieldCheck className="w-8 h-8 text-[#0022FF]" />,
        ...
        {
            icon: <BarChart3 className="w-8 h-8 text-[#0022FF]" />,
        ...
        <div className="py-20 lg:py-32 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
                    <div>
                        <h2 className="text-[#0022FF] font-bold uppercase tracking-widest text-sm mb-4">Research Excellence</h2>
                        ...
                        <p className="text-[#0F1E3A]/70 text-xl leading-relaxed mb-8">
                            At Eskosays, we bridge the gap between global brands and authentic consumer voices. Our proprietary research panels are built on trust, transparency, and high-quality data.
                        </p>
                        <div className="flex gap-4">
                            <button className="px-8 py-4 bg-gradient-to-r from-[#0022FF] to-[#4FD1E8] text-white font-bold rounded-2xl hover:shadow-lg hover:shadow-blue-500/20 transition-all active:scale-95 shadow-md">Partner With Us</button>
                    ...
                    <div className="grid sm:grid-cols-2 gap-6">
                        {features.map((feature, index) => (
                            <div key={index} className="p-8 bg-gray-50/50 rounded-3xl border border-gray-100 hover:border-[#0022FF]/30 hover:bg-white transition-all duration-300">
                ...
                <div className="bg-[#0F1E3A] rounded-[3rem] p-12 lg:p-20 text-white relative overflow-hidden text-center lg:text-left shadow-2xl">
                    <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#0022FF] pointer-events-none opacity-10 rounded-full -translate-y-1/2 translate-x-1/2 blur-[100px]" />
